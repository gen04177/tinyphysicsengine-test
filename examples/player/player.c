...
void printHelp(void)
{
    printf("Player: example program for tinyphysicsengine.\n\n");
...
int main(void)
{
  ...
  while (helper_running)
  {
    ...
    if (onGround)
    {
      if (SDL_GameControllerGetButton(controller, SDL_CONTROLLER_BUTTON_A) && jumpCountdown == 0)
      {
...
#define D 15 // just some vector divisor to make the speed slower
      ...
      // Move forward with Left Stick Up
